...
#[Let's connect on Goood Reads](https://www.goodreads.com/user/show/110707570-everhard-ortega "title")

## Top picks

* [High Output Management](https://www.goodreads.com/book/show/324750.High_Output_Management?ac=1&from_search=true&qid=alY5fhX07w&rank=2 "title")
...
<TOCInline toc={props.toc} exclude="Fav Business Books" toHeading={2} />
...
## Theme colors (https://tailwindcss.com/docs/customizing-colors)
